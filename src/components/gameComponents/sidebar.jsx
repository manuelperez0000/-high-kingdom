...
const Sidebar = () => {
    const { setPhase, setBoardState, setCurrentPlayer, setIsPlayerTurn, isPlayerTurn } = useGameStore();
    ...
    return (
        <div className="game-left">
            ...
            <div className="game-options">
                <div className="current-turn d-flex align-items-center  justify-content-between">
